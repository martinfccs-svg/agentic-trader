...
class System(str, Enum):
    SWING = "swing"
    INTRADAY = "intraday"
    MEANREV = "meanrev"      # RSI mean reversion (contrarian)
    XSECTMOM = "xsectmom"    # cross-sectional (relative) momentum
...
class SignalSource(str, Enum):
    ...
    MEAN_REVERSION = "mean_reversion"  # RSI oversold     -> meanrev
    REL_STRENGTH = "rel_strength"      # top-ranked return -> xsectmom
