...
KNOWN = {
    ...
    "DAILY_LOOKBACK_DAYS", "DAILY_LOSS_LIMIT", "DAILY_LOSS_PCT", "CYCLE_CRIT_SECS", "CYCLE_WARN_SECS", "DASHBOARD_PATH", "DATA_DIR", "FEED_SLOW_MS", "FEED_TIMEOUT_SECS", "DEGRADED_AFTER_CYCLES", "SAME_TICKER_MAX_PCT", "DESK_BUDGET_PCT",
