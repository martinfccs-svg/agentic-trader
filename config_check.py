...
KNOWN = {
    ...
    "DAILY_LOOKBACK_DAYS", "DAILY_LOSS_LIMIT", "DAILY_LOSS_PCT", "BACKTEST_EXECUTION_LAG", "TOOL_ALLOW_SERVICE", "BACKTEST_WARMUP_BARS", "CYCLE_CRIT_SECS", "CYCLE_WARMUP_CYCLES", "CYCLE_WARN_SECS", "DASHBOARD_PATH", "DATA_DIR", "FEED_SLOW_MS", "FEED_TIMEOUT_SECS", "DEGRADED_AFTER_CYCLES", "SAME_TICKER_MAX_PCT", "DESK_BUDGET_PCT",
...
RANGES = {
    ...
    "CYCLE_WARN_SECS": (1, 120, "seconds"),
    "CYCLE_WARMUP_CYCLES": (0, 20, "cycles exempt from the critical watchdog"),
    "CYCLE_CRIT_SECS": (2, 300, "seconds; blocks the NEXT cycle's entries"),
    "FEED_TIMEOUT_SECS": (0.5, 15.0, "seconds; a hang blocks the whole cycle"),
    "FEED_SLOW_MS": (100, 10000, "log threshold for a slow feed call"),
